...
class ProfileRepositoryImpl implements ProfileRepository {
  ...
  Future<Either<Failure, void>> changepassword({required String oldPassword, required String newPassword}) async{
   try {
   await profileDataSource.changepassword(newPassword: newPassword,
  ...
  @override
  Future<Either<Failure, void>> followUnfollowUser({required String userId})async {
  try {
  ...
  @override
  Future<Either<Failure, UserProfile>> getUserProfile({required String userId})async {
  try {
   

    final userProfileModel =  await profileDataSource.getUserProfile(userId: userId);
  ...
  @override
  Future<Either<Failure, User>> getprofilePhotoAndName({required String userId}) async{
    try {
    final userModel =  await profileDataSource.getprofilePhotoAndName(userId: userId);
  ...
  @override
  Future<Either<Failure, void>> modifyprofile({String? userName,
      File? photo,
      String? firstName,
    ...
    try {
  await profileDataSource.modifyprofile(about: about,
    birthDate: birthDate,
    city: city,
    country: country,
    email: email,
